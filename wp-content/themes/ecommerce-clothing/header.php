...
$ecommerce_clothing_menu_text_color = get_theme_mod('ecommerce_clothing_menu_text_color', '#000000'); 
$ecommerce_clothing_sub_menu_text_color = get_theme_mod('ecommerce_clothing_sub_menu_text_color', 'var(--background-color-white)'); 
    ...
    <?php if (get_theme_mod('ecommerce_clothing_enable_preloader', false)) : ?>
        <div id="loader" class="<?php echo esc_attr(get_theme_mod('ecommerce_clothing_preloader_style', 'style1')); ?>">
            <div class="loader-container">
                <div id="preloader">
                    <?php 
                    $ecommerce_clothing_preloader_style = get_theme_mod('ecommerce_clothing_preloader_style', 'style1');
                    if ($ecommerce_clothing_preloader_style === 'style1') : ?>
                        <!-- STYLE 1 -->
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/resource/loader.gif'); ?>" alt="<?php esc_attr_e('Loading...', 'ecommerce-clothing'); ?>">
                    <?php elseif ($ecommerce_clothing_preloader_style === 'style2') : ?>
                        <!-- STYLE 2 -->
                        <div class="dot"></div>
                    <?php elseif ($ecommerce_clothing_preloader_style === 'style3') : ?>
                        <!-- STYLE 3 -->
                        <div class="bars">
                            <div class="bar"></div>
                            <div class="bar"></div>
                                ...
                                <nav id="site-navigation" class="main-navigation">
                                    ...
                                    <style>
                                        ...
                                        .main-navigation ul li a, .menu a {
                                            color: <?php echo esc_attr($ecommerce_clothing_menu_text_color); ?>;
                                        }
                                        ...
                                        .home .main-navigation ul ul a {
                                            color: <?php echo esc_attr($ecommerce_clothing_sub_menu_text_color); ?>;
                                        }                                           
                                    </style>
                                </nav>
                            </div>
